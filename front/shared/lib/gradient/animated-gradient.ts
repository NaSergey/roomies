...
// Орбиты вытянуты по X и прижаты по Y НЕ для красоты движения: светлота фона
// разложена по вертикальным зонам (globals.css), верхняя пара узлов светлая,
// нижняя тёмная. Уехав по Y в чужую зону, узел становится пятном не в тон
// подложке — ровно то, из-за чего фон выглядел набором клякс. Поэтому ry
// маленький и центры орбит держатся в своей трети экрана.
const POINTS: readonly OrbitPoint[] = [
  { key: 'g1', cx: 22, cy: 25, rx: 12, ry: 8, dir: 1 },
  { key: 'g2', cx: 78, cy: 22, rx: 12, ry: 8, dir: -1 },
  { key: 'g3', cx: 25, cy: 78, rx: 12, ry: 8, dir: -1 },
  { key: 'g4', cx: 75, cy: 78, rx: 12, ry: 8, dir: 1 },
];
